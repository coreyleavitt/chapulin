...
- **Stage:** 2 (`/tdd` in progress, 2026-09-13) — running `/loop /tdd the rfc til done` (autonomous, no-defer). **Slices 0 + 1 DONE + verified.** Next: slice 2 (client tab + pump translation + t_gui_pump.nim under NoopBackend).
